...
public class PinyinUtils {
    ...
    public String[] toAllPinYin(char c, HanyuPinyinOutputFormat format) {
        return org.clever.common.utils.pinyin.PinyinUtils.toAllPinYin(c, format);
    }
    ...
    public String toPinYin(char c, HanyuPinyinOutputFormat format) {
        return org.clever.common.utils.pinyin.PinyinUtils.toPinYin(c, format);
    }
    ...
    public String getStringPinYin(String str, String separator, HanyuPinyinOutputFormat format) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringPinYin(str, separator, format);
    }
    ...
    public String getStringPinYin(String str, String separator) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringPinYin(str, separator);
    }
    ...
    public String getStringPurePinYin(String str, String separator, HanyuPinyinOutputFormat format) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringPurePinYin(str, separator, format);
    }
    ...
    public String getStringPurePinYin(String str, String separator) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringPurePinYin(str, separator);
    }
    ...
    public String getStringHeadPinYin(String str, String separator) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringHeadPinYin(str, separator);
    }
    ...
    public String getStringHeadPurePinYin(String str, String separator) {
        return org.clever.common.utils.pinyin.PinyinUtils.getStringHeadPurePinYin(str, separator);
    }
