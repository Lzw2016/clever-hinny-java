...
public class ImageValidateUtils {
    ...
    public boolean createImageStream(String code, OutputStream outputStream) {
        return org.clever.common.utils.imgvalidate.ImageValidateUtils.createImageStream(code, outputStream);
    }
    ...
    public byte[] createImage(String code) {
        return org.clever.common.utils.imgvalidate.ImageValidateUtils.createImage(code);
    }
