...
public class DigestUtils {
    ...
    public byte[] generateSalt(int numBytes) {
        return org.clever.common.utils.codec.DigestUtils.generateSalt(numBytes);
    }
    ...
    public byte[] hmacSha1(byte[] input, byte[] key) {
        return org.clever.common.utils.codec.CryptoUtils.hmacSha1(input, key);
    }
    ...
    public boolean isHmacSha1Valid(byte[] expected, byte[] input, byte[] key) {
        return org.clever.common.utils.codec.CryptoUtils.isHmacSha1Valid(expected, input, key);
    }
    ...
    public byte[] sha1(byte[] data) {
        return org.clever.common.utils.codec.DigestUtils.sha1(data);
    }
    ...
    public byte[] sha1(byte[] data, byte[] salt) {
        return org.clever.common.utils.codec.DigestUtils.sha1(data, salt);
    }
    ...
    public byte[] sha1(byte[] data, byte[] salt, int iterations) {
        return org.clever.common.utils.codec.DigestUtils.sha1(data, salt, iterations);
    }
    ...
    public byte[] sha1(InputStream input) {
        return org.clever.common.utils.codec.DigestUtils.sha1(input);
    }
    ...
    public byte[] md5(byte[] data) {
        return org.clever.common.utils.codec.DigestUtils.md5(data);
    }
    ...
    public byte[] md5(byte[] data, byte[] salt) {
        return org.clever.common.utils.codec.DigestUtils.md5(data, salt);
    }
    ...
    public byte[] md5(byte[] data, byte[] salt, int iterations) {
        return org.clever.common.utils.codec.DigestUtils.md5(data, salt, iterations);
    }
    ...
    public byte[] md5(InputStream input) {
        return org.clever.common.utils.codec.DigestUtils.md5(input);
    }
}
