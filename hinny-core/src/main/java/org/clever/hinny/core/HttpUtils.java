...
public class HttpUtils {
    ...
    public HttpResponse execRequest(final String method, String url, final Object body, final Map<String, String> params, final Map<String, String> headers) {
        ...
        if (HttpMethod.requiresRequestBody(method)) {
            requestBody = RequestBody.create(MediaType.parse(org.clever.common.utils.HttpUtils.MediaType_Json), json);
        } else if (body != null) {
            requestBody = RequestBody.create(MediaType.parse(org.clever.common.utils.HttpUtils.MediaType_Json), json);
        }
        builder.method(method.toUpperCase(), requestBody);
        Request request = builder.build();
        Response response = org.clever.common.utils.HttpUtils.execute(delegate.getOkHttpClient(), request);
