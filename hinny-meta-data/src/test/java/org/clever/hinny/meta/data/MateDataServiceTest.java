...
public class MateDataServiceTest {
    ...
    @Test
    public void t02() {
        DataBaseSummary dataBaseSummary = mateDataService.getDataBaseSummary("clever-template");
        log.info("###dataBaseSummary -> {}", dataBaseSummary);

        TableSchema tableSchema = mateDataService.getTableSchema("clever-template", "hyb_orders");
