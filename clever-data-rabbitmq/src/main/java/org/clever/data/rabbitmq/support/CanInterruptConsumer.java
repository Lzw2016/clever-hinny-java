...
//        Assert.notNull(dataSourceId, "dataSourceId 不能为 null");
...
//        Assert.notNull(consumerMessages.getJobLogger(), "consumerMessages jobLogger 不能为 null");
//        this.jobLogger = consumerMessages.getJobLogger();
...
//    }
//
//    public CanInterruptConsumer(String dataSourceId, Channel channel, String queue, boolean autoAck, int prefetchCount, ConsumerMessages consumerMessages) {
//        this(dataSourceId, channel, queue, autoAck, prefetchCount, consumerMessages, null);
//    }
//
//    /**
//     * 当消费者注册成功
...
//        jobLogger.warn("通道Channel或基础连接关闭 [queue={}] [consumerTag={}] handleShutdownSignal", queue, consumerTag, sig);
//        onStop(sig);
//    }
//
//    /**
...
//        } catch (Exception e) {
//            jobLogger.warn("messages消费失败 [queue={}] [consumerTag={}]", queue, consumerTag, e);
//        }
//        if (interrupted) {
//            doInterrupt();
//        }
...
//            jobLogger.info("[中断消费] - [queue={}] [consumerTag={}] 消费中断成功", queue, consumerTag);
//            channel.close();
//            onStop(null);
//        } catch (Exception e) {
//            jobLogger.warn("[中断消费] - [queue={}] [consumerTag={}] 消费中断失败", queue, consumerTag, e);
//            try {
//                channel.abort();
//                jobLogger.info("[中断消费] - [queue={}] [consumerTag={}] 强制取消消费成功", queue, consumerTag);
//                channel.close();
//                onStop(null);
//            } catch (Exception ex) {
//                jobLogger.warn("[中断消费] - [queue={}] [consumerTag={}] 强制取消消费失败", queue, consumerTag, e);
//            }
//        }
//    }
//
...
//                    jobLogger.warn("Consumer Wait For End Error", e);
//                }
